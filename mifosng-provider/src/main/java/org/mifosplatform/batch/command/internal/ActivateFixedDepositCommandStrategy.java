 ...
 * BatchRequest to
 * {@link org.mifosplatform.portfolio.client.api.FixedDepositApiResource} and gets
 * back the response. This class will also catch any errors raised by
 * {@link org.mifosplatform.portfolio.client.api.FixedDepositApiResource} and map
 ...
 */
@Component
public class ActivateFixedDepositCommandStrategy implements CommandStrategy {

    private final FixedDepositAccountsApiResource fixedDepositAccountsApiResource;

    @Autowired
    public ActivateFixedDepositCommandStrategy(final FixedDepositAccountsApiResource fixedDepositAccountsApiResource) {
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        try {
            ...
            responseBody = fixedDepositAccountsApiResource.handleCommands(accountId, "activate", uriInfo, request.getBody());
