...
import org.mifosplatform.portfolio.savings.api.FixedDepositAccountsApiResource;
 ...
 * BatchRequest to
 * {@link org.mifosplatform.portfolio.client.api.SavingsApiResource} and gets
 ...
 */
@Component
public class ApproveFixedDepositCommandStrategy implements CommandStrategy {

    private final FixedDepositAccountsApiResource fixedDepositAccountsApiResource;

    @Autowired
    public ApproveFixedDepositCommandStrategy(final FixedDepositAccountsApiResource fixedDepositAccountsApiResource) {
        this.fixedDepositAccountsApiResource = fixedDepositAccountsApiResource;
    }
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        try {
            ...
            // Calls 'approve' function from 'FixedDepositAccountsApiResource' to approve a savings          
            responseBody = fixedDepositAccountsApiResource.handleCommands(accountId, "approve", uriInfo, request.getBody());

            response.setStatusCode(200);
            // Sets the body of the response after the successful approval of a savings
