...
public class ApproveRecurringDepositCommandStrategy implements CommandStrategy {
    ...
    @Autowired
    public ApproveRecurringDepositCommandStrategy(final RecurringDepositAccountsApiResource recurringDepositAccountsApiResource) {
    ...
    public BatchResponse execute(final BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        try {
            ...
            responseBody = recurringDepositAccountsApiResource.handleCommands(accountId, "approve", uriInfo, request.getBody());
