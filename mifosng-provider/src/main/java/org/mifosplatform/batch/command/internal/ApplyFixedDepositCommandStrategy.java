 ...
 * applies a new fixed deposit on an existing client. It passes the contents of the
 * body from the BatchRequest to
 * {@link org.mifosplatform.portfolio.savings.api.FixedDepositAccountsApiResource} and
 ...
 */
@Component
public class ApplyFixedDepositCommandStrategy implements CommandStrategy {

    private final FixedDepositAccountsApiResource fixedDepositAccountsApiResource;

    @Autowired
    public ApplyFixedDepositCommandStrategy(final FixedDepositAccountsApiResource fixedDepositAccountsApiResource) {
    ...
    public BatchResponse execute(BatchRequest request, @SuppressWarnings("unused") UriInfo uriInfo) {
        ...
        try {
            ...
            // client
            responseBody = fixedDepositAccountsApiResource.submitApplication(request.getBody());
